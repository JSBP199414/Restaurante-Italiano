...
function Producto(e) {
    ...
    //console.log(buton);
    const item = button.closest('.sectionGrid')//Al momento de dar click visualizamos el item mas cercano con la clase '.sectionGrid'
    //console.log(item);
...
function precioTotal() {
    ...
    carrito.forEach((item)=>{
        ...
        if (item.titulo == 'Pizza Camarones' || item.titulo == 'Pizza Hawaina'|| item.titulo == 'Pizza Napolitana'
        || item.titulo == 'Pizza Carnes' || item.titulo == 'Pasta Carbonada'|| item.titulo == 'Pasta Vegetariana') {
